                    ...
                    <div class="card-body px-0">
						...
						{{-- Table --}}
							<div class="table-responsive">
								<table class="tw-table-fixed tw-w-full tw-text-black tw-text-sm mt-4 tw-border-collapse tw-border">
									<thead>
										<tr class="tw-bg-sky-50 tw-border-b tw-text-xs text-center text-uppercase">
											<th class="p-3">Name</th>
											<th class="p-3">Item Code</th>
											<th class="p-3">Item Unit</th>
											<th class="p-3">Price ({{ __('messages.currency') }})</th>
											<th class="p-3">Types</th>
									...
									<tbody>
										...
										<tr class="tw-bg-white text-uppercase tw-border tw-border-gray-200 hover:tw-bg-gray-50">
											<td class="tw-border p-1 text-center">{{ $row->name_of_goods }}</td>
											<td class="tw-border p-1 text-center">{{ $row->item_code }}</td>
											<td class="tw-border p-1 text-center">{{ $row->item_unit }}</td>
											<td class="tw-border p-1 text-right">
												{{ __('messages.currency') }}
													{{ number_format($row->price_of_goods, 0, ',', '.') }},00
											</td>
											<td class="tw-border p-1 text-center">{{ $row->types_of_goods }}</td>
											<td class="tw-border p-1 text-center">
